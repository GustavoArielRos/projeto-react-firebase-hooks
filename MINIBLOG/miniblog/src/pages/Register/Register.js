...
const Register = () => {
    ...
    // Define estados para armazenar os valores dos campos do formulário
    ...
    //erro do backend
    //Você está desestruturando o objeto retornado pelo useAuthentication para acessar createUser, 
            ...
            <form onSubmit={handleSubmit}>
                <label>
                    ...
                    <input 
                        ...
                        value={displayName} // Valor atual do campo
                        onChange={(e) => setDisplayName(e.target.value)}//Atualiza o state ao mudar o valor
                    />
                </label>
                <label>
                    <span>Email:</span>
